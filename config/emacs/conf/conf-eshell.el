...
;;   (define-key eshell-mode-map (kbd "s-M-t") 'vmacs-eshell-term-new)
;;   ;; (define-key eshell-mode-map (kbd "s-M-n") 'vmscs-eshell-next)
;;   ;; (define-key eshell-mode-map (kbd "s-M-p") 'vmscs-eshell-prev)
