...
(def-cursor-undo meow-right                      nil     nil      nil)
(def-cursor-undo golden-ratio-scroll-screen-up t     nil      nil)
(def-cursor-undo golden-ratio-scroll-screen-down t     nil      nil)
(def-cursor-undo meow-next-symbol nil     nil      nil)
(def-cursor-undo meow-search t     nil      nil)
