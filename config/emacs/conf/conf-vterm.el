...
(helixel-define-key 'insert (kbd "C-r") #'vmacs-vterm-self-insert 'vterm-mode)
  (helixel-define-key 'insert (kbd "C-r") #'vmacs-vterm-self-insert 'vterm-mode)
  (helixel-define-key 'insert (kbd "C-l") #'vterm-clear 'vterm-mode)
  (helixel-define-key 'insert (kbd "C-g") #'vterm-ctrl-g 'vterm-mode)
  (helixel-define-key 'insert (kbd "<escape>") #'vterm--self-insert 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-g") #'vterm-ctrl-g 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-p") #'vmacs-vterm-self-insertvterm-ctrl-g 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-n") #'vmacs-vterm-self-insert 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-k") #'vmacs-vterm-kill-line 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-k") #'vmacs-vterm-kill-line 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-r") #'vmacs-vterm-self-insert 'vterm-mode)
  (helixel-define-key 'normal (kbd "C-y") #'vterm-yank 'vterm-mode)
  (helixel-define-key 'normal "G" #'vterm-eob 'vterm-mode)
