...
;;; return to original point location.
  ...
  (list
   ...
   (make-diverted-event :from 'meow-bounds-of-thing
                        ...
                        :breadcrumb (lambda ()
                                      ...
                                      (meow-pop-selection)))
   (make-diverted-event :from 'meow-inner-of-thing
                        :to 'indent-for-tab-command
                        :breadcrumb (lambda ()
                                      (exchange-point-and-mark)
                                      (meow-pop-selection)))
   (make-diverted-event :from 'mark-defun
                        :to 'indent-for-tab-command
                        :breadcrumb #'diverted--pop-to-mark-command)
...
(defun diverted--pop-to-mark-command (&optional n)
