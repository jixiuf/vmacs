...

;;;### (autoloads nil "sqlplus" "sqlplus.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sqlplus" '("sqlplus-" "get-all-dirs" "plsql-" "connect-string-to-string" "col-desc" "refine-connect-string" "font-lock-sqlplus-face" "orcl-mode")))
