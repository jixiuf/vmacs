...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cape corfu-terminal kind-icon corfu vundo consult-dir vterm-toggle pinyinlib org-msg mu4e-alert marginalia verb embark-consult orderless eglot ox-gfm htmlize git-link dockerfile-mode iedit osx-dictionary magit dired-filetype-face golden-ratio-scroll-screen exec-path-from-shell go-mode golden-ratio lua-mode markdown-mode protobuf-mode wgrep with-editor yaml-mode yasnippet))
