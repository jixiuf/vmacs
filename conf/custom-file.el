...
(custom-set-variables
 ...
 '(package-selected-packages
   '(git-modes vterm-toggle pinyinlib org-msg clhs mu4e-alert marginalia evil-collection verb embark-consult orderless eglot undo-tree magit-libgit docker-tramp ox-gfm centaur-tabs htmlize git-link evil dockerfile-mode iedit osx-dictionary magit dired-filetype-face golden-ratio-scroll-screen company evil-textobj-anyblock exec-path-from-shell git-commit go-mode golden-ratio lua-mode markdown-mode protobuf-mode wgrep with-editor yaml-mode yasnippet))
 ...
 '(warning-suppress-types '((eglot) (comp) (comp) (yasnippet backquote-change)))
