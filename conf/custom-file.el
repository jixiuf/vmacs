...
(custom-set-variables
 ...
 '(package-selected-packages
   '(orderless eglot undo-tree rg magit-libgit docker-tramp ox-gfm centaur-tabs htmlize evil-magit git-link evil dockerfile-mode iedit osx-dictionary dired-narrow magit gitconfig-mode dired-filetype-face golden-ratio-scroll-screen company evil-textobj-anyblock exec-path-from-shell git-commit go-mode golden-ratio lua-mode markdown-mode protobuf-mode wgrep with-editor yaml-mode yasnippet))
