...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot eshell-prompt-extras company-posframe dockerfile-mode helm-core git-timemachine json-mode iedit go-imports sane-term shell-toggle osx-dictionary dired-narrow smex ivy-dired-history counsel flx magit gitconfig-mode company-jedi dired-filetype-face company-go auto-compile golden-ratio-scroll-screen company evil-textobj-anyblock exec-path-from-shell applescript-mode bm erlang ethan-wspace evil-magit flycheck git-commit go-eldoc go-mode golden-ratio goto-chg logstash-conf lua-mode markdown-mode protobuf-mode thrift web-mode wgrep with-editor yaml-mode yasnippet))
