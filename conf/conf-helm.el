...
;; (vmacs-leader "spc" 'helm-multi-files)
;; (vmacs-leader "ff" 'helm-find-files)
;; (vmacs-leader "fh" 'helm-find-files)
;; (vmacs-leader "fl" 'helm-locate)
;; (vmacs-leader "fg" 'helm-ls-git-ls)
;; (define-key evil-normal-state-map "sl" 'helm-locate)

;; (vmacs-leader "?" 'helm-descbinds)
;; (vmacs-leader "wi" 'helm-semantic-or-imenu)
;; (vmacs-leader "b" 'helm-resume)
;; (vmacs-leader "wy" 'helm-all-mark-rings)
;; (vmacs-leader "wp" 'helm-list-emacs-process)

;; (vmacs-leader ";" 'helm-m-x)
;; (vmacs-leader "；" 'helm-m-x)
;; (vmacs-leader "g" 'helm-search)
