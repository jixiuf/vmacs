...
;; (vmacs-leader (kbd "spc") 'helm-multi-files)
;; (vmacs-leader (kbd "ff") 'helm-find-files)
;; (vmacs-leader (kbd "fh") 'helm-find-files)
;; (vmacs-leader (kbd "fl") 'helm-locate)
;; (vmacs-leader (kbd "fg") 'helm-ls-git-ls)
;; (define-key evil-normal-state-map "sl" 'helm-locate)

;; (vmacs-leader (kbd "?") 'helm-descbinds)
;; (vmacs-leader (kbd "wi") 'helm-semantic-or-imenu)
;; (vmacs-leader (kbd "b") 'helm-resume)
;; (vmacs-leader (kbd "wy") 'helm-all-mark-rings)
;; (vmacs-leader (kbd "wp") 'helm-list-emacs-process)

;; (vmacs-leader (kbd ";") 'helm-m-x)
;; (vmacs-leader (kbd "；") 'helm-m-x)
;; (vmacs-leader (kbd "g") 'helm-search)
