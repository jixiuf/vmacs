...
(define-key vterm-raw-map (kbd "C-x C-e")   #'vterm-send-ctrl-x-ctrl-e)
(define-key vterm-raw-map (kbd "M-.")   #'vterm--self-insert)
(define-key vterm-raw-map (kbd "C-g")   #'vterm-ctrl-g)
(define-key vterm-raw-map (kbd "C-c C-g")   #'vterm--self-insert)
(define-key vterm-common-map (kbd "s-v")   #'vterm-yank)
(define-key vterm-raw-map (kbd "C-k")   #'vterm-kill-line)
(define-key vterm-raw-map [(control return)]   #'vterm-compile)
(define-key vterm-raw-map [f2]   nil)
(define-key vterm-raw-map [f3]   nil)
;; (define-key vterm-raw-map (kbd "s-t")   #'vterm)
(define-key vterm-common-map [return] #'vterm-send-return)
