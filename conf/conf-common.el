...
(setq-default
 ...
 frame-title-format '("%e " evil-mode-line-format mode-line-buffer-identification " "   mode-line-client   mode-line-position (vc-mode vc-mode) "  "  mode-line-misc-info mode-line-end-spaces "%f  GNU/Emacs")
